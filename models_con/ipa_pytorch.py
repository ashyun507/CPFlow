...
class InvariantPointAttention(nn.Module):
    ...
    def forward(
        ...
        # [*, N_res, N_res]
        # PyTorch 2.4+ no longer allows bool tensor arithmetic like (bool - 1).
        # Build the pair mask in bool, then cast to attention dtype before math.
        square_mask = mask.unsqueeze(-1) & mask.unsqueeze(-2)
        square_mask = square_mask.to(dtype=a.dtype)
        square_mask = self.inf * (square_mask - 1.0)
